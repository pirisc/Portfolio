...
🔧 Tech: Python, PyTorch, scikit-learn, pandas, SQL, TensorFlow, using different IA APIs.
🧠 Interests: ML models, AI tools, applied data science.  
🚀 Current focus: building end-to-end ML projects with real-world use cases.
